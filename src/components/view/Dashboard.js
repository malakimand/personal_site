...
return (
    ...
    <div >
      ...
      <div className="container valign-wrapper" style={{ height: "60vh" }}>
        <div className="row">
       ...
       <div className="hide-on-large-only">
        <div className="container" style={{ height: "60vh" }}>
          ...
          <div className="row center-align">
           ...
           <div className="row card-panel grey lighten-4 z-depth-1">
            <div className = "valign-wrapper">
              <i className="material-icons md-24">sports_basketball</i> 
              <h4 className = "container "><b>NBA Feed </b></h4>
              <Link to="/nba" className="btn waves-effect z-depth-3 container">
               Explore
            </Link>
            </div>
            <p>Because I'm a huge fan of basketball</p>
          ...
          <div className="row card-panel grey lighten-4 z-depth-1">
          <div className = "valign-wrapper">
              <i className="material-icons md-24">code</i> 
              <h4 className = "container "><b>Leetcode</b></h4>
              <Link to="/leetcode/1" className="btn waves-effect z-depth-3 container">
               Explore
            </Link>
            </div>
            <p>Because I enjoy solving coding challenges</p>
         ...
         <div className="row card-panel grey lighten-4 z-depth-1">
            <div className = "valign-wrapper">
              ...
              <Link to="/aboutme" className="btn waves-effect z-depth-3 container">
               Explore
            </Link>
            </div>
            <p>Because I'm proud of the work I've done</p>
